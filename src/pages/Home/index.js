...
export default function Home({ navigation, route }) {
  ...
  return (
    ...
    <View>
      <TouchableNativeFeedback onPress={() => navigation.navigate('Perjumlahan')}>
        <View>
      <Image source={require('../../assets/menuperjumlahan.png')} style={{
        width:136,
        height:224,
      }}/>
        </View>
      ...
      <View>
      <TouchableNativeFeedback onPress={() => navigation.navigate('Pengurangan')}>
        <View>
      <Image source={require('../../assets/menupengurangan.png')} style={{
        width:136,
        height:224,
      }}/>
        </View>
    ...
    <View>
      <TouchableNativeFeedback onPress={() => navigation.navigate('Perkalian')}>
        <View>
      <Image source={require('../../assets/menuperkalian.png')} style={{
        width:136,
        height:224,
      }}/>
        </View>
      ...
      <View>
      <TouchableNativeFeedback onPress={() => navigation.navigate('Pembagian')}>
        <View>
      <Image source={require('../../assets/menupembagian.png')} style={{
        width:136,
        height:224,
      }}/>
        </View>

...
import Perjumlahan from './Perjumlahan';
import Pembagian from './pembagian';
import Perkalian from './perkalian';
import PerjumlahanSubMenu from './Perjumlahan/submenu';
import PerjumlahanKalkulator from './Perjumlahan/kalkulator';
import HasilPerjumlahan from './Perjumlahan/hasil';
import PembahasanPerjumlahan from './Perjumlahan/pembahasan';
import PenguranganKalkulator from './pengurangan/kalkulator';
import HasilPengurangan from './pengurangan/hasil';
import PembahasanPengurangan from './pengurangan/pembahasan';
import PenguranganSubMenu from './pengurangan/submenu';
import PerkalianSubMenu from './perkalian/submenu';
import PerkalianKalkulator from './perkalian/kalkulator';
import HasilPerkalian from './perkalian/hasil';
import PembahasanPerkallian from './perkalian/pembahasan';
import PembagianSubMenu from './pembagian/submenu';
import PembagianKalkulator from './pembagian/kalkulator';
import HasilPembagian from './pembagian/hasil';
import PembahasanPembagian from './pembagian/pembahasan';

...
export default function HasilPengurangan({navigation}) {
    const Back = () => {
        navigation.navigate('Pengurangan')
    }
  return (
    <View style={{flex:1, backgroundColor:colors.primary}}>
      ...
      <ScrollView>
              ...
              <View style={{backgroundColor:'white', padding:10, borderRadius:20}}>
                ...
                <MyGap jarak={24}/>
                <TouchableNativeFeedback onPress={() => navigation.navigate('PembahasanPengurangan')}>

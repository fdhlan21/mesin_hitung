...
export default function PenguranganKalkulator({ navigation }) {
    const Back = () => {
        navigation.goBack();
    };
    ...
    return (
        <View style={{ flex: 1, backgroundColor: colors.primary }}>
            {/* HEADER */}
            <View style={{
                padding: 10, backgroundColor: colors.headerpengurangan, flexDirection: "row",
...
<MyGap jarak={10}/>
                    ...
                    <View style={{ flexDirection: 'row', top:-7}}>
                        ...
                        <TouchableOpacity
                            onPress={() => navigation.navigate('HasilPengurangan')}
                            style={{
                                height: 350,
                                margin: 5,

...
export default function PerkalianKalkulator({ navigation }) {
    const Back = () => {
        navigation.goBack();
    };
    ...
    return (
        <View style={{ flex: 1, backgroundColor: colors.primary }}>
            {/* HEADER */}
            <View style={{
                padding: 10, backgroundColor: colors.headerperkalian, flexDirection: "row",
...
<MyGap jarak={10}/>
                    ...
                    <View style={{ flexDirection: 'row', top:-7}}>
                        ...
                        <TouchableOpacity
                            onPress={() => navigation.navigate('HasilPerkalian')}
                            style={{
                                height: 350,
                                margin: 5,
